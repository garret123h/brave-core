...
#define SPEEDREADER_FEATURE_ENTRIES                                \
  { "brave-speedreader", flag_descriptions::kBraveSpeedreaderName, \
...
#define BRAVE_SYNC_FEATURE_ENTRIES                        \
  { "brave-sync-v2", flag_descriptions::kBraveSyncName,   \
...
#define BRAVE_IPFS_FEATURE_ENTRIES                        \
  { "brave-ipfs", flag_descriptions::kBraveIpfsName,      \
...
#define BRAVE_FEATURE_ENTRIES                                                \
  { "use-dev-updater-url", flag_descriptions::kUseDevUpdaterUrlName,         \
    ...
    FEATURE_VALUE_TYPE(brave_component_updater::kUseDevUpdaterUrl)},         \
      ...
      SPEEDREADER_FEATURE_ENTRIES BRAVE_SYNC_FEATURE_ENTRIES                 \
